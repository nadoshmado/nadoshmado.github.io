...
{	
	...
	if(x==x1&&y==y1) {
			if (!r) 
			{
				...
				(q)?o.setAttribute("src","giraffe_jam.gif"):o.setAttribute("src","giraffe_jam2.gif");
	...
	o=document.getElementById("p");
	if (s) {o.setAttribute("src","giraffe_go.gif"); s=0;}
	else {o.setAttribute("src","giraffe_go1.gif"); s=1;}
	o.style.left=x1+'px';
	o.style.top=y1+'px';
...
{	
	...
	if (s) {o.setAttribute("src","giraffe_goc.gif"); s=0;}
	else {o.setAttribute("src","giraffe_goc1.gif"); s=1;}
	o.style.left=x1+'px';
	o.style.top=y1+'px';
...
function eat() {
	...
	(q)?o.setAttribute("src","giraffe_fat.gif"):o.setAttribute("src","giraffe_fat2.gif");
	g=0;
	r=1;
...
function pov() {
	...
	o=document.getElementById("p");
	if (q) {
		o.setAttribute("src","giraffe_go.gif");
		q=0;
	}
	else {
		o.setAttribute("src","giraffe_goc.gif");
		q=1;
	}
}
